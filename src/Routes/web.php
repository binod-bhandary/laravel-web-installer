...
Route::group(['prefix' => 'install','as' => 'LaravelWebInstaller::','namespace' => 'Vinus\LaravelWebInstaller\Controllers','middleware' => ['web', 'install']], function() {
    Route::get('/', [
        'as' => 'welcome',
...
Route::group(['prefix' => 'update','as' => 'LaravelUpdater::','namespace' => 'Vinus\LaravelWebInstaller\Controllers','middleware' => 'web'],function() {
