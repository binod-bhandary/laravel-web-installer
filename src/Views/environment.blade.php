...
@section('container')
    ...
    <div class="buttons">
        <a href="{{ route('LaravelWebInstaller::environmentWizard') }}" class="button button-wizard">
            <i class="fa fa-sliders fa-fw" aria-hidden="true"></i> {{ trans('installer_messages.environment.menu.wizard-button') }}
        </a>
        <a href="{{ route('LaravelWebInstaller::environmentClassic') }}" class="button button-classic">
